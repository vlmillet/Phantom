...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("Optional")
        ...
        .public_()
            ...
            .PHANTOM_T constructor<void(T const&)>()({"a_Val"})
            .PHANTOM_T constructor<void(T&&)>()({"a_Val"})
            .PHANTOM_T constructor<void(const SelfType&)>()({"a_Other"})
            .PHANTOM_T constructor<void(SelfType&&)>()({"a_Temp"})
            .PHANTOM_T constructor<void(_NullOpt)>()({""})
            .PHANTOM_T method<SelfType&(const SelfType&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"a_Other"})
            .PHANTOM_T method<SelfType&(SelfType&&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"a_Temp"})
            .PHANTOM_T method<SelfType&(_NullOpt)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({""})
            .PHANTOM_T method<SelfType&(T&&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"a_Temp"})
            .PHANTOM_T method<SelfType&(T const&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"a_Val"})
