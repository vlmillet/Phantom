...
{
    this_().function<size_t(void const*)>("_dllModuleHandleFromAddress", _dllModuleHandleFromAddress);
}
...
PHANTOM_REGISTER(Functions)
{
    this_().function<void(StringView, StringBuffer&, ::phantom::reflection::LanguageElement*)>(
    "conversionOperatorNameNormalizer", conversionOperatorNameNormalizer);
}
#endif // PHANTOM_NOT_TEMPLATE
PHANTOM_END("phantom")
PHANTOM_END("phantom")
...
PHANTOM_CLASS_T((class, class, bool), (t_Target, t_Source, t_SourceIsObject), asH)
{
    this_();
}
PHANTOM_END("phantom")
...
#if PHANTOM_NOT_TEMPLATE
PHANTOM_REGISTER(Enums)
{
    this_().enum_<RegistrationStep>().values({{"_None", RegistrationStep::_None},
...
PHANTOM_REGISTER(Typedefs)
{
    this_().typedef_<RegistrationSteps>("RegistrationSteps");
}
PHANTOM_REGISTER(Enums)
{
    this_().enum_<TypeInstallationStep>().values({{"Uninstalled", TypeInstallationStep::Uninstalled},
...
/// missing symbol(s) reflection (phantom::Delegate) -> use the 'haunt.bind' to bind symbols with your custom haunt
/// files
...
PHANTOM_REGISTER(Enums)
{
    this_().enum_<MessageType>().values({{"Undefined", MessageType::Undefined},
...
/// missing symbol(s) reflection () -> use the 'haunt.bind' to bind symbols with your custom haunt files
// PHANTOM_REGISTER(Functions) { this_().function<void(int, const PrintDelegate&)>("setPrintDelegate",
// setPrintDelegate);}
PHANTOM_REGISTER(Functions)
{
    this_().function<bool()>("isMainThread", isMainThread);
}
#endif // PHANTOM_NOT_TEMPLATE
PHANTOM_END("phantom")
PHANTOM_END("phantom")
