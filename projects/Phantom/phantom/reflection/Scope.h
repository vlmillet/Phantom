...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Removes the given type from this scope.
    ///
    /// \param a_pType The type to remove.
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    void removeType(Type* a_pType);

    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets a type at given index position.
    ///
    ...
    /// \internal
    ///
    /// \param  a_Guid    Unique identifier.
    ///
    /// \return null if it fails, else the type by unique identifier.
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    Type* getTypeByGuid(uint a_Guid) const;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets the class at given index position (among the class found, not the absolute type
    /// index).
    ///
    /// \param  a_uiIndex   The index.
    ///
    ...
    Class* getClass(size_t a_uiIndex) const;

    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets the class count in this scope.
    ///
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Removes the given template from this scope.
    ///
    /// \param a_pTemplate The template to remove.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ///
    /// \param a_pTemplateSpecialization  The template specialization to remove.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Removes a variable from this scope.
    ///
    /// \param  a_pVariable The variable to remove.
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    void removeVariable(Variable* a_pVariable);

    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets the variable at given index position.
    ///
    /// \param  a_uiIndex   The index.
    ///
    /// \return The variable at given index position.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Removes a constant from this scope.
    ///
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets the constant at given index position.
    ///
    /// \param  a_uiIndex   The index.
    ///
    /// \return The constant at given index position.
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    Constant* getConstant(size_t a_uiIndex) const;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Removes an alias from this scope
    ///
    /// \param [in,out] a_pAlias    The alias to remove.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets the alias at given index position.
    ///
    /// \param  a_uiIndex   The index.
    ///
    /// \return The alias at given position.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Removes a function from this scope.
    ///
    /// \param [in,out] a_pFunction The function to remove.
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    void removeFunction(Function* a_pFunction);

    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets the function at given index position.
    ///
    /// \param  a_uiIndex   The index.
    ///
    /// \return The function at given index position.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Adds an anonymous section to this namespace with given C++ code and optional
    /// modifiers.
    ///
    /// \param  a_strCode   The C++ code to parse.
    /// \param  a_Modifiers (optional) the modifiers.
    ///
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// \brief  Gets the anonymous section at given index position.
    ///
    /// \param  a_uiIndex   The index.
    ///
    /// \return null if it fails, else the anonymous section.
    ////////////////////////////////////////////////////////////////////////////////////////////////////
