...
PHANTOM_PACKAGE("phantom")
    PHANTOM_SOURCE("Path")
        ...
        PHANTOM_STRUCT_S((phantom::Path), StringConverter)
        {
            using StringBuffer = typedef_< phantom::StringBuffer>;
            using StringView = typedef_< phantom::StringView>;
            this_()
            .staticMethod<void(const ::phantom::reflection::Class *, StringBuffer&, const Path*)>("toLiteral", &_::toLiteral)
            .staticMethod<void(const ::phantom::reflection::Class *, StringBuffer&, const Path*)>("to", &_::to)
            .staticMethod<void(const ::phantom::reflection::Class *, StringView, Path*)>("from", &_::from)
            ;
        }
    PHANTOM_END("Path")
PHANTOM_END("phantom")
