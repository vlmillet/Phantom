...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("SmallSet")
        ...
        .public_()
            ...
            .PHANTOM_T method<T const&(size_t) const>("operator[]", &_::operator[])({"i"})
            .PHANTOM_T method<const_iterator(T const&) const>("find", &_::find)({"a_Val"})
            .PHANTOM_T method<iterator(T const&)>("find", &_::find)({"a_Val"})
            .PHANTOM_T method<size_t(T const&)>("erase", &_::erase)({"a_Val"})
            .PHANTOM_T method<Pair<iterator, bool>(T const&)>("insert", &_::insert)({"a_Val"})
            .PHANTOM_T method<const_iterator(const T&) const>("lower_bound", &_::lower_bound)({"a_Val"})
            .PHANTOM_T method<iterator(const T&)>("lower_bound", &_::lower_bound)({"a_Val"})
