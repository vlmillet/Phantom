...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("SmallVectorBasedContainer")
        ...
        PHANTOM_STRUCT_T((class), (t_Ty), Less)
        {
            ...
            .PHANTOM_T method<bool(const t_Ty&, const t_Ty&) const>("operator()", &_::operator())({"_Left","_Right"})
            ;
        }
        ...
        .public_()
            ...
            .PHANTOM_T method<iterator(const_iterator)>("erase", &_::erase)({"a_Where"})
            .PHANTOM_T method<iterator(const_iterator, const_iterator)>("erase", &_::erase)({"a_From","a_To"})
