...
PHANTOM_EXPORT_PHANTOM extern uint32_t SmallStringTotalSize;
PHANTOM_EXPORT_PHANTOM extern uint32_t SmallStringTotalCount;
#endif
...
public:
    ...
    {
        m_Chars.clear();
        m_Chars.insert(m_Chars.end(), a_Other.m_Chars.begin(), a_Other.m_Chars.end());
        return *this;
    }
...
template<class CharT, uint32_t S>
...
template<class CharT, class Traits, uint32_t S>
