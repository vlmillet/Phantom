...
PHANTOM_TYPEDEF(intptr_t);
PHANTOM_TYPEDEF(uintptr_t);
PHANTOM_TYPEDEF(int8_t);
PHANTOM_TYPEDEF(uint8_t);
PHANTOM_TYPEDEF(int16_t);
PHANTOM_TYPEDEF(uint16_t);
PHANTOM_TYPEDEF(int32_t);
PHANTOM_TYPEDEF(uint32_t);
PHANTOM_TYPEDEF(int64_t);
PHANTOM_TYPEDEF(uint64_t);
PHANTOM_TYPEDEF(intptr_t);
PHANTOM_TYPEDEF(uintptr_t);
PHANTOM_END("c.def");
