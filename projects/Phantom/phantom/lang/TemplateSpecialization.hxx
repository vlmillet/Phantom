...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("TemplateSpecialization")
        ...
        .public_()
            ...
            .constructor<void(TemplateSpecialization*, const LanguageElements&, const PlaceholderMap&)>()({"a_pInstantiationSpecialization","arguments","a_PlaceholderSubstitutions"})
