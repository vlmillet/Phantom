...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("SmallVector")
        ...
        .public_()
            ...
            .PHANTOM_T constructor<void(size_t), explicit_>()({"a_Count"})
            .PHANTOM_T constructor<void(CustomAllocator const*), explicit_>()({"a_pMemTraits"})
            .PHANTOM_T constructor<void(const ::std::initializer_list<value_type> &)>()({"inits"})
            .PHANTOM_T constructor<void(ArrayViewType)>()({"inits"})
            .PHANTOM_T constructor<void(const SelfType&)>()({"other"})
            .PHANTOM_T constructor<void(iterator, iterator)>()({"_it","_end"})
            .PHANTOM_T constructor<void(const_iterator, const_iterator)>()({"_it","_end"})
            .PHANTOM_T constructor<void(SelfType&&)>()({"temp"})
            .PHANTOM_T method<void(CustomAllocator const*)>("setAllocator", &_::setAllocator)({"a_pAlloc"})
            .PHANTOM_T method<SelfType&(const SelfType&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"other"})
            .PHANTOM_T method<SelfType&(SelfType&&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"temp"})
            ...
            .PHANTOM_T method<value_type&(size_type)>("operator[]", &_::operator[])({"i"})
            .PHANTOM_T method<value_type const&(size_type) const>("operator[]", &_::operator[])({"i"})
            ...
            .PHANTOM_T method<void(size_type)>("reserve", &_::reserve)({"_capacity"})
            .PHANTOM_T method<void(size_type)>("resize", &_::resize)({"newSize"})
            .PHANTOM_T method<void(size_type, const value_type&)>("resize", &_::resize)({"newSize","init"})
            .PHANTOM_T method<void(size_type, value_type&&)>("resize", &_::resize)({"newSize","init"})
            .PHANTOM_T method<void(const value_type&)>("push_back", &_::push_back)({"val"})
            .PHANTOM_T method<iterator(const_iterator)>("erase", &_::erase)({"_it"})
            .PHANTOM_T method<iterator(const_iterator)>("erase_unsorted", &_::erase_unsorted)({"_it"})
            .PHANTOM_T method<iterator(const_iterator, const_iterator)>("erase", &_::erase)({"_it","_last"})
            .PHANTOM_T method<iterator(iterator, iterator, iterator)>("insert", &_::insert)({"_where","_it","_end"})
            .PHANTOM_T method<iterator(const_iterator, iterator, iterator)>("insert", &_::insert)({"_where","_it","_end"})
            .PHANTOM_T method<iterator(const_iterator, const_iterator, const_iterator)>("insert", &_::insert)({"_where","_it","_end"})
            .PHANTOM_T method<iterator(iterator, const_iterator, const_iterator)>("insert", &_::insert)({"_where","_it","_end"})
            .PHANTOM_T method<iterator(iterator, const value_type&)>("insert", &_::insert)({"_where","val"})
            .PHANTOM_T method<ArrayViewType() const>("operator ArrayViewType", &_::operator notypedef<ArrayViewType>)
            .PHANTOM_T method<iterator(iterator, value_type&&)>("insert", &_::insert)({"_where","val"})
            .PHANTOM_T method<void(value_type&&)>("push_back", &_::push_back)({"val"})
            .PHANTOM_T method<void()>("clear", &_::clear)
            .PHANTOM_T method<void(SelfType&)>("swap", &_::swap)({"other"})
            ;
        }
