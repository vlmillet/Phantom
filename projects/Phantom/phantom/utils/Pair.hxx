...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("Pair")
        ...
        PHANTOM_STRUCT_T((class, class), (t_First, t_Second), Pair)
        {
            ...
            .PHANTOM_T constructor<void(t_First const&, t_Second const&)>()({"a_First","a_Second"})
            .PHANTOM_T constructor<void(t_First&&, t_Second&&)>()({"a_First","a_Second"})
            .PHANTOM_T constructor<void(t_First&&, t_Second const&)>()({"a_First","a_Second"})
            .PHANTOM_T constructor<void(t_First const&, t_Second&&)>()({"a_First","a_Second"})
