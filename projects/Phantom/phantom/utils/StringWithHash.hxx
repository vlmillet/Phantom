...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("StringWithHash")
        ...
        {
            this_()
            // .method<size_t(const ::phantom::StringWithHash &)>("operator()", &_::operator())({"_hash"})
            ;
        } */
...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("StringWithHash")
        ...
        .public_()
            ...
            .constructor<void(StringWithHash const&)>()({"_other"})
            .method<StringWithHash&(StringWithHash const&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)({"_other"})
            ...
            .method<bool(StringWithHash const&) const>("operator<", &_::operator<)({"_other"})
            .method<bool(StringWithHash const&) const>("operator==", &_::operator==)({"_other"})
            .method<bool(StringWithHash const&) const>("operator!=", &_::operator!=)({"_other"})
