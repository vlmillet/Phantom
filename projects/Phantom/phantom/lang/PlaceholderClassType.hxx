...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("PlaceholderClassType")
        ...
        .public_()
            .constructor<void(PlaceholderType*)>()({"a_pPlaceholderType"})
            .constructor<void(StringView, Modifiers, uint)>()({"a_Name","a_Modifiers","a_Flags"})
            ...
            .method<::phantom::lang::PlaceholderClassType *() const, virtual_>("asPlaceholderClassType", &_::asPlaceholderClassType)
