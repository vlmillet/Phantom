...
PHANTOM_PACKAGE("phantom")
    PHANTOM_SOURCE("MethodPointer")
        ...
        PHANTOM_CLASS_T((class, class), (T, Sign), MethodPointer)
        {
            this_()
            ;
        }
        PHANTOM_STRUCT_TVS((class, class), (T, R), (class, Params), (T, R(Params...)), MethodPointer)
        {
            ...
            .PHANTOM_T method<R(T*, Params...) const>("operator()", &_::operator())
            ;
        }
