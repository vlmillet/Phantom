...
#    else
#        define PHANTOM_MODULE_HANDLE(...)                                                         \
            ::phantom::_dllModuleHandleFromAddress((void const*)(__VA_ARGS__))
#    endif
...
PHANTOM_EXPORT_PHANTOM void conversionOperatorNameNormalizer(StringView                   a_strName,
                                                             StringBuffer&                a_Buf,
...
typedef bool (*MessageReportFunc)(StringView expression, StringView file, int line,
                                  const char* format, va_list arglist);
typedef void (*LogFunc)(MessageType msgType, StringView file, int line, const char* format,
                        va_list arglist);
...
PHANTOM_EXPORT_PHANTOM bool assertion PHANTOM_PREVENT_MACRO_SUBSTITUTION(const char* e,
                                                                         const char* f, int l,
                                                                         const char* format, ...);
PHANTOM_EXPORT_PHANTOM bool warning PHANTOM_PREVENT_MACRO_SUBSTITUTION(const char* e, const char* f,
                                                                       int l, const char* format,
                                                                       ...);
PHANTOM_EXPORT_PHANTOM bool error PHANTOM_PREVENT_MACRO_SUBSTITUTION(const char* e, const char* f,
                                                                     int l, const char* format,
                                                                     ...);
PHANTOM_EXPORT_PHANTOM void log PHANTOM_PREVENT_MACRO_SUBSTITUTION(MessageType level,
