...
PHANTOM_PACKAGE("phantom.reflection")
    PHANTOM_SOURCE("LanguageElement")
        ...
        .public_()
            ...
            .method<StlMapClass*() const, virtual_>("asMapContainerClass", &_::asMapContainerClass)
            ...
            .method<StlSetClass*() const, virtual_>("asSetContainerClass", &_::asSetContainerClass)
