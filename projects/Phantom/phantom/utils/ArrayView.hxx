...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("ArrayView")
        ...
        .public_()
            ...
            .PHANTOM_T constructor<void(const T*, size_t)>()({"a_pData","a_Size"})
            .PHANTOM_T constructor<void(const T*, const T*)>()({"a_pData","a_pEnd"})
            .PHANTOM_T constructor<void(::std::initializer_list<T>)>()({"a_InitList"})
            .PHANTOM_T constructor<void(T const&)>()({"a_Single"})
