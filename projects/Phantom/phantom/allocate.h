...
#include <phantom/Allocator.h>

namespace phantom
{
#define PHANTOM_ALLOCATE(...) ::phantom::allocate<__VA_ARGS__>(PHANTOM_MEMORY_STAT_INSERT_VALUES)
#define PHANTOM_ALLOCATE_N(n, ...)                                                                 \
    ::phantom::allocate<__VA_ARGS__>(n PHANTOM_MEMORY_STAT_APPEND_VALUES)
#define PHANTOM_REALLOCATE_N(ptr, n, ...)                                                          \
    ::phantom::reallocate<__VA_ARGS__>(ptr, n PHANTOM_MEMORY_STAT_APPEND_VALUES)
