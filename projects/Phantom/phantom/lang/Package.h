...
public:
    ...
    Source* getOrCreateSource(StringView a_strName, Visibility a_Visibility = Visibility::Public);
    ...
    Source* newSource(StringView a_Name, Visibility a_Visibility = Visibility::Public);
