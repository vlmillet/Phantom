...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("RecursiveInstanceVisitorT")
        ...
        .public_()
            ...
            .PHANTOM_T method<bool(InstanceT<ArrayClass>)>("visitArrayClass", &_::visitArrayClass)({"a_Input"})
            .PHANTOM_T method<bool(InstanceT<ArrayClass>)>("endArrayClass", &_::endArrayClass)({"a_Input"})
            ...
            .PHANTOM_T method<bool(InstanceT<ArrayClass>)>("traverse", &_::traverse)({"a_Input"})
