...
#define _PHNTM_TRTS_SPEC_NT(_trait_, _type_, _value_, _namespaces_, _template_types_,              \
                            _template_params_, _name_)                                             \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_)>                                  \
    struct _trait_<PHANTOM_PP_CREATE_QUALIFIED_NAME(_namespaces_, _name_) <                        \
...
#define _PHNTM_TRTS_SPEC_NPT(_trait_, _type_, _value_, _namespaces_, _template_types_,             \
                             _template_params_, _template_spec_, _name_)                           \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_)>                                  \
    struct _trait_<PHANTOM_PP_CREATE_QUALIFIED_NAME(_namespaces_, _name_) <                        \
                   PHANTOM_PP_IDENTITY _template_spec_>> final                                     \
        : public std::integral_constant<_type_, PHANTOM_PP_REMOVE_PARENS(_value_)>                 \
    {                                                                                              \
    };                                                                                             \
    }
...
#define _PHNTM_TRTS_SPEC_TP(_trait_, _type_, _value_, _template_types_, _template_params_,         \
                            _spec_params_, _name_)                                                 \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_)>                                  \
...
#define _PHNTM_TRTS_SPEC_CT(_trait_, _type_, _value_, _classes_, _template_types_,                 \
                            _template_params_, _name_)                                             \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_)>                                  \
    struct _trait_<PHANTOM_PP_CREATE_QUALIFIED_NAME(_classes_, _name_) <                           \
                   PHANTOM_PP_IDENTITY _template_params_>> final                                   \
        : public std::integral_constant<_type_, PHANTOM_PP_REMOVE_PARENS(_value_)>                 \
    {                                                                                              \
    };                                                                                             \
...
#define _PHNTM_TRTS_SPEC_NCT(_trait_, _type_, _value_, _namespaces_, _classes_, _template_types_,  \
                             _template_params_, _name_)                                            \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_)>                                  \
...
#define _PHNTM_TRTS_SPEC_TV(_trait_, _type_, _value_, _template_types_, _template_params_,         \
    ...
    struct _trait_<                                                                                \
    ::_name_<PHANTOM_PP_IDENTITY _template_params_, PHANTOM_PP_ARG_1 _variadic_pair_...> >         \
...
#define _PHNTM_TRTS_SPEC_CTV(_trait_, _type_, _value_, _classes_, _template_types_,                \
                             _template_params_, _variadic_pair_, _name_)                           \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_),                                  \
             PHANTOM_PP_ARG_0 _variadic_pair_... PHANTOM_PP_ARG_1 _variadic_pair_>                 \
...
#define _PHNTM_TRTS_SPEC_NTV(_trait_, _type_, _value_, _namespaces_, _template_types_,             \
                             _template_params_, _variadic_pair_, _name_)                           \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_),                                  \
...
#define _PHNTM_TRTS_SPEC_NCTV(_trait_, _type_, _value_, _namespaces_, _classes_, _template_types_, \
                              _template_params_, _variadic_pair_, _name_)                          \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_MIX(_template_types_, _template_params_),                                  \
...
#define _PHNTM_TRTS_SPEC_NCV(_trait_, _type_, _value_, _namespaces_, _classes_, _variadic_pair_,   \
                             _name_)                                                               \
    namespace phantom                                                                              \
    {                                                                                              \
    template<PHANTOM_PP_ARG_0 _variadic_pair_... PHANTOM_PP_ARG_1 _variadic_pair_>                 \
