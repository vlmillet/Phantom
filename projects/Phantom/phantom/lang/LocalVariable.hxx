...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("LocalVariable")
        ...
        .public_()
            ...
            .method<void(ptrdiff_t)>("setEvalFrameOffset", &_::setEvalFrameOffset)({"a_iOffset"})
            .method<void(ptrdiff_t)>("setNativeFrameOffset", &_::setNativeFrameOffset)({"a_iOffset"})
            ...
            .method<LocalVariable*(LanguageElement*) const>("clone", &_::clone)({"a_pOwner"})
            .method<::phantom::lang::LocalVariable *(LanguageElement*) const, virtual_>("cloneImpl", &_::cloneImpl)({"a_pOwner"})
