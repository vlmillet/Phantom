...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("Path")
        ...
        PHANTOM_STRUCT(Path)
        {
            ...
            .method<::phantom::SmallVector<SmallString<char, 20>, 16>::const_iterator() const>("begin", &_::begin)
            .method<::phantom::SmallVector<SmallString<char, 20>, 16>::const_iterator() const>("end", &_::end)
