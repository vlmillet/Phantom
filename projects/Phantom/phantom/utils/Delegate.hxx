...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("Delegate")
        ...
        .public_()
            ...
            .PHANTOM_T constructor<void(const phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&)>()
            .PHANTOM_T constructor<void(phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&&)>()
            /// missing symbol(s) reflection (phantom::Delegate::FuncPtrT) -> use the 'haunt.bind' to bind symbols with your custom haunt files
            // .PHANTOM_T constructor<void(phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::FuncPtrT)>()
            .PHANTOM_T constructor<void(OpaqueDelegate const&)>()
            .PHANTOM_T method<Delegate<type-parameter-0-0 (type-parameter-0-1...)>&(const phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .PHANTOM_T method<Delegate<type-parameter-0-0 (type-parameter-0-1...)>&(const OpaqueDelegate&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .PHANTOM_T method<Delegate<type-parameter-0-0 (type-parameter-0-1...)>&(phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&&)>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .PHANTOM_T method<Delegate<type-parameter-0-0 (type-parameter-0-1...)>&(R (*)(Params...))>("operator=", &PHANTOM_REFLECTED_TYPE::operator=)
            .PHANTOM_T method<bool(const phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&) const>("operator==", &_::operator==)
            .PHANTOM_T method<bool(const phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&) const>("operator!=", &_::operator!=)
            .PHANTOM_T method<bool(const phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&) const>("operator<", &_::operator<)
            .PHANTOM_T method<bool(const phantom::Delegate<type-parameter-0-0 (type-parameter-0-1...)>::SelfType&) const>("operator>", &_::operator>)
            .PHANTOM_T method<void(R (*)(Params...))>("bind", &_::bind)
