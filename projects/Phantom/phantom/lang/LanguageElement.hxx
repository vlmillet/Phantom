...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("LanguageElement")
        ...
        .public_()
            .method<void(::phantom::lang::LanguageElementVisitor *, VisitorData), virtual_>("visit", &_::visit)({"a_pVisitor","a_Data"})
        ...
        .public_()
            ...
            .staticMethod<::phantom::lang::Symbol *(Symbol*, bool)>("NoFilter", &_::NoFilter)({"a_pSymbol",""})
            .staticMethod<::phantom::lang::Symbol *(Symbol*, bool)>("PublicFilter", &_::PublicFilter)({"a_pSymbol","a_bUnamedSubSymbol"})
            .staticMethod<::phantom::lang::Symbol *(Symbol*, bool)>("PublicIfUnamedSubSymbolFilter", &_::PublicIfUnamedSubSymbolFilter)({"a_pSymbol","a_bUnamedSubSymbol"})
            .method<void()>("initialize", &_::initialize)
            .method<void(), virtual_|override_>("terminate", &_::terminate)
        
        .public_()
            .struct_<NewCallSite>()
                .constructor<void(LanguageElement*), explicit_>()({"a_pElem"})
                .field("this_", &_::NewCallSite::this_)
            .end()
            .method<const ::phantom::CustomAllocator *() const, virtual_>("getAllocator", &_::getAllocator)
            .method<void(LanguageElement*)>("Delete", &_::Delete)({"a_pLanguageElement"})
            .method<LanguageElementsView() const>("getElements", &_::getElements)
            .method<bool() const>("isTemplateElement", &_::isTemplateElement)
            .method<bool(LanguageElement*) const>("hasReferencedElement", &_::hasReferencedElement)({"a_pLanguageElement"})
            .method<bool(LanguageElement*) const>("hasReferencingElement", &_::hasReferencingElement)({"a_pLanguageElement"})
            ...
            .method<bool(LanguageElement*) const>("hasElement", &_::hasElement)({"a_pElement"})
            .method<bool(Symbol*) const>("hasFriendCascade", &_::hasFriendCascade)({"a_pElement"})
            .method<bool(LanguageElement*) const>("hasOwnerCascade", &_::hasOwnerCascade)({"a_pElement"})
            .method<bool(LanguageElement*) const>("hasElementCascade", &_::hasElementCascade)({"a_pElement"})
            ...
            .method<void(LanguageElements&, Class*) const>("fetchElementsDeep", &_::fetchElementsDeep)({"out","a_pClass"})["nullptr"]
            .method<void(LanguageElements&, Class*) const>("fetchElements", &_::fetchElements)({"out","a_pClass"})["nullptr"]
            .method<void(StringView, Symbols&) const>("getSymbolsWithName", &_::getSymbolsWithName)({"a_strName","a_OutSymbols"})
            .method<void(Symbols&) const>("getSymbols", &_::getSymbols)({"a_OutSymbols"})
            .method<bool(StringView) const>("hasSymbol", &_::hasSymbol)({"a_strName"})
            ...
            .method<bool(LanguageElement*) const, virtual_>("isSame", &_::isSame)({"a_pOther"})
            ...
            .method<bool(LanguageElement*, size_t&, PlaceholderMap&) const, virtual_>("partialAccepts", &_::partialAccepts)({"a_pLanguageElement","a_Score","a_Deductions"})
            .method<void(LanguageElements&) const>("getElements", &_::getElements)({"a_Elements"})
            .method<void(Symbols&) const>("fetchSymbols", &_::fetchSymbols)({"a_Symbols"})
            .method<void(Symbols&, SymbolFilter, bool, bool) const>("fetchSymbols", &_::fetchSymbols)({"a_Symbols","a_Filter","a_bIncludeUnamedSubSymbols","a_bRecursive"})["true"]["false"]
            .method<void(LanguageElements&) const>("getElementsDeep", &_::getElementsDeep)({"a_Elements"})
            .method<Symbol*(StringView, Modifiers, uint) const>("getUniqueElement", &_::getUniqueElement)({"name","modifiers","a_uiFlags"})["0"]["0"]
            .method<size_t(LanguageElement*) const>("getElementIndex", &_::getElementIndex)({"a_pElement"})
            /// missing symbol(s) reflection (std::basic_ostream) -> use the 'haunt.bind' to bind symbols with your custom haunt files
            // .method<void(::std::basic_ostream<char> &) const>("dumpElementList", &_::dumpElementList)({"out"})
            /// missing symbol(s) reflection (std::basic_ostream) -> use the 'haunt.bind' to bind symbols with your custom haunt files
            // .method<void(::std::basic_ostream<char> &) const>("dumpElementListCascade", &_::dumpElementListCascade)({"out"})
            .method<String() const, virtual_>("getQualifiedDecoratedName", &_::getQualifiedDecoratedName)
            .method<String(LanguageElement*) const, virtual_>("getRelativeDecoratedName", &_::getRelativeDecoratedName)({"a_pTo"})
            ...
            .method<void(StringBuffer&) const, virtual_>("getName", &_::getName)({"a_Buf"})
            ...
            .method<void(StringBuffer&) const, virtual_>("getUniqueName", &_::getUniqueName)({"a_Buf"})
            .method<::phantom::lang::LanguageElement *() const, virtual_>("getNamingScope", &_::getNamingScope)
            .method<bool(LanguageElement*) const>("hasNamingScopeCascade", &_::hasNamingScopeCascade)({"a_pScope"})
            .method<void()>("detach", &_::detach)
            .method<bool(Symbol*) const, virtual_>("isSymbolHidden", &_::isSymbolHidden)({"a_pSymbol"})
            .method<uint() const>("getFlags", &_::getFlags)
            .method<void(uint)>("setFlag", &_::setFlag)({"flag"})
            .method<void(uint)>("addFlags", &_::addFlags)({"flags"})
            .method<void(uint)>("removeFlags", &_::removeFlags)({"flags"})
            .method<void(uint)>("setFlags", &_::setFlags)({"flags"})
            .method<bool(uint) const>("testFlags", &_::testFlags)({"flags"})
            ...
            .method<void(const CodePosition&)>("setCodePosition", &_::setCodePosition)({"a_CodePosition"})
            ...
            .method<LanguageElement*(const CodePosition&) const>("getElementAtCodePosition", &_::getElementAtCodePosition)({"a_CodePosition"})
            .method<LanguageElement*(uint16) const>("getElementAtLine", &_::getElementAtLine)({"a_Line"})
            .method<int() const, virtual_>("destructionPriority", &_::destructionPriority)
            .method<void(LanguageElement*)>("setOwner", &_::setOwner)({"a_pOwner"})
            .method<void(LanguageElement*)>("addReferencedElement", &_::addReferencedElement)({"a_pRef"})
