...
PHANTOM_PACKAGE("phantom.utils")
    PHANTOM_SOURCE("Signal")
        ...
        .public_()
            ...
            .PHANTOM_T method<FunctorID(OpaqueDynDelegate&&)>("connect", &_::connect)({"a_ODynDelegate"})
            .PHANTOM_T method<FunctorID(OpaqueDynDelegate const&)>("connect", &_::connect)({"a_ODynDelegate"})
            .PHANTOM_T method<FunctorID(FunctorType const&)>("connect", &_::connect)({"a_Functor"})
            .PHANTOM_T method<FunctorID(FunctorType&&)>("connect", &_::connect)({"a_Functor"})
            .PHANTOM_T method<FunctorID(const Delegate<void (Parms...)>&)>("connect", &_::connect)({"a_Delegate"})
            .PHANTOM_T method<FunctorID(Delegate<void (Parms...)>&&)>("connect", &_::connect)({"a_Delegate"})
            .PHANTOM_T method<void(OpaqueDynDelegate const&)>("disconnect", &_::disconnect)({"a_ODynDelegate"})
            .PHANTOM_T method<void(OpaqueDynDelegate&&)>("disconnect", &_::disconnect)({"a_ODynDelegate"})
            .PHANTOM_T method<void(FunctorID)>("disconnect", &_::disconnect)({"a_ID"})
            .PHANTOM_T method<void(const Delegate<void (Parms...)>&)>("disconnect", &_::disconnect)({"a_Delegate"})
            .PHANTOM_T method<void(Delegate<void (Parms...)>&&)>("disconnect", &_::disconnect)({"a_Delegate"})
            .PHANTOM_T method<void(Parms...) const>("operator()", &_::operator())({"a_Args"})
            .PHANTOM_T method<void(void*, Parms...) const>("emit", &_::emit)({"a_pThis","a_Args"})
