...
{
    _PHNTM_REG_STATIC_ASSERT(phantom::IsTypeDefined<UnionT<T>>::value,
...
struct DefaultUnionBuilderT : UnionBuilderT<T, Top, DefaultUnionBuilderT<T, Top>>
{
    ...
    DefaultUnionBuilderT(Top* a_pTop, Access, TemplateSpecArgumentRegistrer a_TArgs)
        : BaseType(a_pTop, a_TArgs)
    {
    }
};
...
#define PHANTOM_UNION_S(TemplateArgs, TypeName, ...)                                               \
    _PHANTOM_CLASS_S(TemplateArgs, TypeName, Public, (__VA_ARGS__))
...
#define PHANTOM_UNION_V(VariadicPair, TypeName, ...)                                               \
    _PHANTOM_CLASS_V(VariadicPair, TypeName, Public, (__VA_ARGS__))
...
#define PHANTOM_UNION_TVS(TemplateTypes, TemplateParams, VariadicPair, TemplateArgs, TypeName,     \
                          ...)                                                                     \
    _PHANTOM_CLASS_TVS(TemplateTypes, TemplateParams, VariadicPair, TemplateArgs, TypeName,        \
                       Public, (__VA_ARGS__))
