...
PHANTOM_PACKAGE("phantom.reflection")
    PHANTOM_SOURCE("LanguageElementVisitor")
        ...
        .public_()
            ...
            .method<void(StlMapClass*, VisitorData), virtual_>("visit", &_::visit)
            ...
            .method<void(StlSetClass*, VisitorData), virtual_>("visit", &_::visit)
            .method<void(StlVectorClass*, VisitorData), virtual_>("visit", &_::visit)
