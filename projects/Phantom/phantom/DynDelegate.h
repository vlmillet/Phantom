...
public:
    ...
    OpaqueDynDelegate(Object a_Object, reflection::Method* a_pMethod);
    OpaqueDynDelegate(reflection::Function* a_pFunction);
    OpaqueDynDelegate(Object a_Object, StringView a_MethodName);
...
public:
    ...
    DynDelegate(Object a_Object, reflection::Method* a_pMethod)
        : OpaqueDynDelegate(a_Object, a_pMethod)
    {
        PHANTOM_ASSERT(_CheckSignature());
    }

    DynDelegate(Object a_Object, StringView a_MethodName)
        : OpaqueDynDelegate(a_Object, a_MethodName)
    {
        PHANTOM_ASSERT(_CheckSignature());
    }
