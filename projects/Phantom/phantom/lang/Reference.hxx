...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("Reference")
        ...
        .protected_()
            .constructor<void(TypeKind, Type*, StringView)>()({"a_eTypeKind","a_pReferencedType","a_strName"})
        ...
        .public_()
            ...
            .method<Type*(Type*) const, pure_virtual|override_>("replicate", &_::replicate)({"a_pSource"})
            ...
            .method<bool(Type*, size_t&, PlaceholderMap&) const, pure_virtual|override_>("partialAccepts", &_::partialAccepts)({"a_pType","a_Score","a_DeducedConstants"})
            .method<bool(Symbol*) const, pure_virtual|override_>("isSame", &_::isSame)({"a_pOther"})
            .method<void(void**, void*)>("address", &_::address)({"a_pArgs","a_pOutput"})
            .method<void(void**, void*)>("memcpyStoreDelegate", &_::memcpyStoreDelegate)({"a_pArgs","a_pOutput"})
