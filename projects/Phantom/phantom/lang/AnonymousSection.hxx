...
PHANTOM_PACKAGE("phantom.lang")
    PHANTOM_SOURCE("AnonymousSection")
        ...
        .public_()
            ...
            .method<Variable*(size_t) const>("getVariable", &_::getVariable)({"a_uiIndex"})
            ...
            .method<void(AnonymousSection*)>("addAnonymousSection", &_::addAnonymousSection)({"a_pAnonymousSection"})
            .method<void(AnonymousSection*)>("removeAnonymousSection", &_::removeAnonymousSection)({"a_pAnonymousSection"})
            .method<AnonymousSection*(size_t) const>("getAnonymousSection", &_::getAnonymousSection)({"a_uiIndex"})
